package hibernate.lesson11.onetomany;
...
public class Lesson11App {
    ...
    public static void main(String[] args) {
        ...
        Student student2 = new Student("Student 2 Name", "Student 2 Surname", 30);
        Student student3 = new Student("Student 3 Name", "Student 3 Surname", 23);
        Student student4 = new Student("Student 4 Name", "Student 4 Surname", 17);
        Student student5 = new Student("Student 5 Name", "Student 5 Surname", 45);
        ...
        group2.getStudents().addAll(Arrays.asList(student1, student2, student4, student5));
        ...
        student3.getGroups().addAll(Arrays.asList(group1));
        student4.getGroups().addAll(Arrays.asList(group2));
        student5.getGroups().addAll(Arrays.asList(group2));
