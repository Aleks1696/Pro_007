...
public class Lesson11App {
    ...
    public static void main(String[] args) {
        ...
        Author author1 = new Author("Author 1", "Author 1 Surname");
        Author author2 = new Author("Author 2", "Author 2 Surname");
        ...
        Book book1 = new Book("Book 1", "Book 1 Description",
                Calendar.getInstance().getTime());
        Book book2 = new Book("Book 2", "Book 2 Description",
                Calendar.getInstance().getTime());
        Book book3 = new Book("Book 3", "Book 3 Description",
                Calendar.getInstance().getTime());
