...
public class Lesson10App {
    ...
    public static void main(String[] args) {
        ...
        Order milk = service.create("MILK", ProductQuality.TOXIC, 5,
                100.00, Calendar.getInstance().getTime());
        Order meat = service.create("MEAT", ProductQuality.PRIMARY, 8,
                200.00, Calendar.getInstance().getTime());
