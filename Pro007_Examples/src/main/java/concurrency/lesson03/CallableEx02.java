...
public class CallableEx02 {
    ...
    /* Callable - появился начиная с JDK 1.5, в составе
    *             Concurrency API, который помогает
    *             вернуть результат выполненой работы
    *             из потока*/
    public static void main(String[] args) {
        ...
        /* newFixedThreadPool - создает процесс с 2мя активными потоками*/
        ExecutorService es = Executors.newFixedThreadPool(2);
        /* submit - позволяет запустить Callable задачу в отдельном потоке
        * Future - класс который позволяет контролировать работу потока и
        *          получить результат выполнения после завершения задачи*/
