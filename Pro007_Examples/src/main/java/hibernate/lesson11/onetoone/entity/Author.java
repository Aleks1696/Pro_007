...
public class Author {
    ...
    /* @SequenceGenerator - аннотация позволяет нам описать свой генератор
    *                       значений для поля ID
    *  name           - имя генеротара на уровне программы
    ...
    *  allocationSize - шаг на который будет изменено значение*/
    @SequenceGenerator(
            ...
            initialValue = 20180000, allocationSize = 25
    )
