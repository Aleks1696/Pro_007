...
public class Lesson11App {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Book 1" , "Book 1 Description", Calendar.getInstance().getTime());
        Book book2 = new Book("Book 2" , "Book 2 Description", Calendar.getInstance().getTime());
        Book book3 = new Book("Book 3" , "Book 3 Description", Calendar.getInstance().getTime());
        session.beginTransaction();
        session.save(book1);
        session.save(book2);
        session.save(book3);
        ...
        session.beginTransaction();
                Author author = session.get(Author.class,20180000L);
